...
public class XRatingBar extends LinearLayout {
    ...
    public XRatingBar(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.XRatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.XRatingBar_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.XRatingBar_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.XRatingBar_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.XRatingBar_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.XRatingBar_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.XRatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.XRatingBar_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.XRatingBar_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.XRatingBar_clickable, true);
        mTypedArray.recycle();
