...
public class XWaveProgressView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(mProgressHeight - getPaddingBottom() + getPaddingTop(),
                mProgressHeight - getPaddingLeft() - getPaddingRight());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画圆边框
        if (isDrawBorder) canvas.drawCircle(mRadius, mRadius, mRadius, mCirclePaint);
