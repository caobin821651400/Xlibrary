...
package com.cb.xlibrary.view.stateview;
 ...
 * 界面loading
 */
public class XStateView extends FrameLayout {
    ...
    public static XStateViewConfig config = new XStateViewConfig();
    LayoutInflater mInflater;
    Map<Integer, View> mLayouts = new HashMap<>();

    public static XStateView wrap(Activity activity) {
        return wrap(((ViewGroup) activity.findViewById(android.R.id.content)).getChildAt(0));
    }

    public static XStateView wrap(Fragment fragment) {
        return wrap(fragment.getView());
    }

    public static XStateView wrap(View view) {
        if (view == null) {
        ...
        XStateView layout = new XStateView(view.getContext());
