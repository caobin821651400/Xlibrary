...
public class XBase64 {
    ...
    public static byte[] decode(byte[] input, int offset, int len, int flags) {
        XBase64.Decoder decoder = new XBase64.Decoder(flags, new byte[len * 3 / 4]);
    ...
    public static byte[] encode(byte[] input, int offset, int len, int flags) {
        XBase64.Encoder encoder = new XBase64.Encoder(flags, (byte[]) null);
    ...
    static class Encoder extends XBase64.Coder {
    ...
    static class Decoder extends XBase64.Coder {
