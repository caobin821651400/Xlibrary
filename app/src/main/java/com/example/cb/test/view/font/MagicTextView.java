...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            String typefaceName = a.getString( R.styleable.MagicTextView_mt_typeface);
            if(typefaceName != null) {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("fonts/%s.ttf", typefaceName));
                setTypeface(tf);
            }

            if(a.hasValue(R.styleable.MagicTextView_mt_foreground)){
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_mt_foreground);
                if(foreground != null){
                    this.setForegroundDrawable(foreground);
                }else{
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_mt_foreground, 0xff000000));
                }
            }

            if(a.hasValue(R.styleable.MagicTextView_mt_background)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_mt_background);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_mt_background, 0xff000000));
                }
            }

            if(a.hasValue(R.styleable.MagicTextView_mt_innerShadowColor)){
                this.addInnerShadow(a.getDimensionPixelSize(R.styleable.MagicTextView_mt_innerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mt_innerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mt_innerShadowDy, 0),
                        a.getColor(R.styleable.MagicTextView_mt_innerShadowColor, 0xff000000));
            }

            if(a.hasValue(R.styleable.MagicTextView_mt_outerShadowColor)){
                this.addOuterShadow(a.getDimensionPixelSize(R.styleable.MagicTextView_mt_outerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mt_outerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mt_outerShadowDy, 0),
                        a.getColor(R.styleable.MagicTextView_mt_outerShadowColor, 0xff000000));
            }

            if(a.hasValue(R.styleable.MagicTextView_mt_strokeColor)){
                float strokeWidth = a.getDimensionPixelSize(R.styleable.MagicTextView_mt_strokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_mt_strokeColor, 0xff000000);
                float strokeMiter = a.getDimensionPixelSize(R.styleable.MagicTextView_mt_strokeMiter, 10);
                Join strokeJoin = null;
                switch(a.getInt(R.styleable.MagicTextView_mt_strokeJoinStyle, 0)){
