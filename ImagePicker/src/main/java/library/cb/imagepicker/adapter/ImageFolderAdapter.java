...
public class ImageFolderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_folder_list_item_cblibrary, parent, false);
        ...
        holder.imageCount.setText(mActivity.getString(R.string.ip_folder_image_count_cblibrary, folder.images.size()));
