package library.cb.imagepicker.view;
...
public class CropImageView extends AppCompatImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CbCropImageView);
        mMaskColor = a.getColor(R.styleable.CbCropImageView_cblibrary_cropMaskColor, mMaskColor);
        mBorderColor = a.getColor(R.styleable.CbCropImageView_cblibrary_cropBorderColor, mBorderColor);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CbCropImageView_cblibrary_cropBorderWidth, mBorderWidth);
        mFocusWidth = a.getDimensionPixelSize(R.styleable.CbCropImageView_cblibrary_cropFocusWidth, mFocusWidth);
        mFocusHeight = a.getDimensionPixelSize(R.styleable.CbCropImageView_cblibrary_cropFocusHeight, mFocusHeight);
        mDefaultStyleIndex = a.getInteger(R.styleable.CbCropImageView_cblibrary_cropStyle, mDefaultStyleIndex);
