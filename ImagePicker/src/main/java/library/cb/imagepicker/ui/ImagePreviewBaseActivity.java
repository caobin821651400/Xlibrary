...
import library.cb.imagepicker.adapter.ImagePageAdapter;
import library.cb.imagepicker.bean.ImageItem;
import library.cb.imagepicker.util.Utils;
import library.cb.imagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_preview_cblibrary);
