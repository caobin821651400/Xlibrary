package library.cb.imagepicker.ui;
...
import library.cb.imagepicker.DataHolder;
import library.cb.imagepicker.ImageDataSource;
import library.cb.imagepicker.ImagePicker;
import library.cb.imagepicker.R;
import library.cb.imagepicker.adapter.ImageFolderAdapter;
import library.cb.imagepicker.adapter.ImageRecyclerAdapter;
import library.cb.imagepicker.bean.ImageFolder;
import library.cb.imagepicker.bean.ImageItem;
import library.cb.imagepicker.util.Utils;
import library.cb.imagepicker.view.FolderPopUpWindow;
import library.cb.imagepicker.view.GridSpacingItemDecoration;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_grid_cblibrary);
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            mBtnOk.setText(getString(R.string.ip_select_complete_cblibrary, imagePicker.getSelectImageCount(), imagePicker.getSelectLimit()));
            mBtnOk.setEnabled(true);
            mBtnPre.setEnabled(true);
            mBtnPre.setText(getResources().getString(R.string.ip_preview_count_cblibrary, imagePicker.getSelectImageCount()));
            mBtnPre.setTextColor(ContextCompat.getColor(this, R.color.ip_text_primary_inverted_cblibrary));
            mBtnOk.setTextColor(ContextCompat.getColor(this, R.color.ip_text_primary_inverted_cblibrary));
        } else {
            mBtnOk.setText("完成");
            mBtnOk.setEnabled(false);
            mBtnPre.setEnabled(false);
            mBtnPre.setText("预览");
            mBtnPre.setTextColor(ContextCompat.getColor(this, R.color.ip_text_secondary_inverted_cblibrary));
            mBtnOk.setTextColor(ContextCompat.getColor(this, R.color.ip_text_secondary_inverted_cblibrary));
        }
