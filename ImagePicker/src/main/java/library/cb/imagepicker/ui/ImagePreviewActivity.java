...
import library.cb.imagepicker.util.NavigationBarChangeListener;
import library.cb.imagepicker.util.Utils;
import library.cb.imagepicker.view.SuperCheckBox;
...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleCount.setText(getString(R.string.ip_preview_image_count_cblibrary, mCurrentPosition + 1, mImageItems.size()));
        ...
        mCbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
                    Toast.makeText(ImagePreviewActivity.this, getString(R.string.ip_select_limit_cblibrary, selectLimit), Toast.LENGTH_SHORT).show();
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        ...
        if (mCbOrigin.isChecked()) {
            ...
            mCbOrigin.setText(getString(R.string.ip_origin_size_cblibrary, fileSize));
        }
    }
    ...
    public void onImageSingleTap() {
        if (topBar.getVisibility() == View.VISIBLE) {
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.ip_top_out_cblibrary));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.ip_fade_out_cblibrary));
...
//            if (Build.VERSION.SDK_INT >= 16) content.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN);
            ...
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.ip_top_in_cblibrary));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.ip_fade_in_cblibrary));
            topBar.setVisibility(View.VISIBLE);
            bottomBar.setVisibility(View.VISIBLE);
            tintManager.setStatusBarTintResource(R.color.ip_color_primary_dark_cblibrary);//通知栏所需颜色
