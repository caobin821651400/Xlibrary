...
public class GlideRoundedCornersTransform extends CenterCrop {
    ...
    public GlideRoundedCornersTransform(Context context, int radius) {
        this(context, radius, CornerType.ALL);
    }

    public GlideRoundedCornersTransform(Context context, int radius, CornerType cornerType) {
        super();
        mRadius = XDensityUtils.dp2px(context, radius);//dp ->px
