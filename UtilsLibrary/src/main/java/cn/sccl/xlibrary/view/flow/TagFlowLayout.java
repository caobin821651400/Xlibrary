package cn.sccl.xlibrary.view.flow;
...
public class TagFlowLayout extends FlowLayout
    ...
    public interface OnLongTagClickListener {
        void onLongSelected(View view, int position, FlowLayout parent);
    }
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.TagFlowLayoutCbLibrary);
        mSelectedMax = ta.getInt(R.styleable.TagFlowLayoutCbLibrary_max_select, -1);
        ta.recycle();
    }
    ...
    public void setOnLongTagClickListener(OnLongTagClickListener listener) {
        mOnLongTagClickListener = listener;
    }
            ...
            tagViewContainer.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if (mOnLongTagClickListener != null) {
                        mOnLongTagClickListener.onLongSelected(finalTagViewContainer, position,
                                TagFlowLayout.this);
                    }
                    return true;
                }
