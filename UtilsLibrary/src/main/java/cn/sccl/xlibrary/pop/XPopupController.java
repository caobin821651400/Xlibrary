...
class XPopupController {
    ...
    XPopupController(Context context, PopupWindow popupWindow) {
    ...
    static class PopupParams {
        ...
        public void apply(XPopupController controller) {
            if (mView != null) {
