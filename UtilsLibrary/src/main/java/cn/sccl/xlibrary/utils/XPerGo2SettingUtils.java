 ...
 * @Desc :权限请求页适配，不同手机系统跳转到不同的权限请求页
 * ====================================================
 */
public class XPerGo2SettingUtils {
    private final String TAG = "XPerGo2SettingUtils";
    private Context mContext;
    //自己的项目包名
    private String packageName = "";

    public XPerGo2SettingUtils(Context context, String name) {
