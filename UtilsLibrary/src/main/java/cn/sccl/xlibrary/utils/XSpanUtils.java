...
//        textview.setText(new XSpanUtils(this)
...
public final class XSpanUtils {
    ...
    public XSpanUtils(Context context) {
     ...
     *             </ul>
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight, @Align final int align) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(final Drawable drawable) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(final Uri uri) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setStrikethrough() {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setUnderline() {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setSuperscript() {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setSubscript() {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link XSpanUtils}
     */
    public XSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
